...
# Check and execute keycloak/script/clean_infra_data.sh
KEYCLOAK_CLEAN_SCRIPT="$BASE_DIR/components/keycloak/script/clean_infra_data.sh"
...
KEYCLOAK_TRUSTSTORE_SCRIPT="$BASE_DIR/components/keycloak/script/generate_truststore_infra.sh"
...
# Check and execute postgresql/script/clean_infra_data.sh
POSTGRESQL_CLEAN_SCRIPT="$BASE_DIR/components/postgresql/script/clean_infra_data.sh"
