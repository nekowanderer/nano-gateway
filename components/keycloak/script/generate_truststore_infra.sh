...
KEYSTORE_FILE="${KEYCLOAK_DIR}/keystore/infra/nano_keycloak_key.keystore"
CERT_FILE="${KEYCLOAK_DIR}/keystore/infra/keycloak-cert.pem"
TRUSTSTORE_FILE="${KEYCLOAK_DIR}/keystore/infra/keycloak-truststore.p12"
...
echo "✅ Truststore created and copied to: ${QUARKUS_TRUSTSTORE_FILE} for infra environment"
