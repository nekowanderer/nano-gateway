...
KEYSTORE_FILE="${KEYCLOAK_DIR}/keystore/dev/nano_keycloak_key.keystore"
CERT_FILE="${KEYCLOAK_DIR}/keystore/dev/keycloak-cert.pem"
TRUSTSTORE_FILE="${KEYCLOAK_DIR}/keystore/dev/keycloak-truststore.p12"
...
echo "✅ Truststore created and copied to: ${QUARKUS_TRUSTSTORE_FILE} for dev environment"
