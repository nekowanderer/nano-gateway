...
# Check and execute keycloak/script/clean_keycloak_data.sh
KEYCLOAK_CLEAN_SCRIPT="$BASE_DIR/components/keycloak/script/clean_keycloak_data.sh"
...
# Check and execute postgresql/script/clean_postgresql_data.sh
POSTGRESQL_CLEAN_SCRIPT="$BASE_DIR/components/postgresql/script/clean_postgresql_data.sh"
